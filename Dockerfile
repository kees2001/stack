...
##   $ docker build -t php-for-kees2001-stack .
##
## RUNNING
##   $ docker run -p 9000:9000 php-for-kees2001-stack
##
## CONNECTING
...
ENV STACKSMITH_STACK_ID="nekx2td" \
    STACKSMITH_STACK_NAME="PHP for kees2001/stack" \
